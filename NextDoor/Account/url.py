...
from .views import SignupPageView, create_request, requests, view_request, user_count, blocked_user_count
...
urlpatterns = [
    ...
    path('blocked_user_count/', blocked_user_count, name="blocked_user_count"),
